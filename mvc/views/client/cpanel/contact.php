					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 0978898989</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> TMQ@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
                                <li><a href="https://www.facebook.com/meomeo"><i class="fa fa-facebook"></i></a></li>
								<li><a href="#"><i class="fab fa-facebook"></i></a></li>
								<li><a href="#"><i class="fab fa-youtube"></i></a></li>
								<li><a href="#"><i class="fab fa-instagram-square"></i></a></li>
								<li><a href="#"><i class="fab fa-google"></i></a></li>
								<li><a href="#"><i class="fab fa-zalo"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
    		...
    		<div class="row" style="margin-top: 100px;">  	
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>E-SHOPPER</p>
							<p>Đắk Mil - Đắk Nông</p>
							<p>Số Điện thoại: 0978898989</p>
							<p>Email: TMQ@gmail.com</p>
	    				</address>
	    			</div>
    			</div>    			
	    	</div>  
